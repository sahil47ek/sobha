...
export default function FeaturedPropertiesSlider({ properties }: FeaturedPropertiesSliderProps) {
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 text-white rounded-full p-1 sm:p-2 backdrop-blur-sm transition-all duration-200"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white/10 hover:bg-white/20 text-white rounded-full p-1 sm:p-2 backdrop-blur-sm transition-all duration-200"
